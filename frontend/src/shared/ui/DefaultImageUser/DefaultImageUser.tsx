...
import styles from "./DefaultImageUser.module.scss";
import clsx from "clsx";
type sizesImage = "small" | "medium" | "large";

interface IProps {
  size?: sizesImage;
}

export const DefaultImageUser = (props: IProps) => {
  const { size = "small" } = props;
  return (
    <div className={clsx(styles.image, styles[size])}>
      <svg
        viewBox="0 0 212 212"
